...
const CreateRecipe = () => {
  ...
  const onSubmit = (data) => {
    ...
    const recipeData = {
      ...data,
      recipeCategory: recipeCategory.charAt(0).toUpperCase() + recipeCategory.slice(1)
    }
    ...
    mutate(recipeData, {
      onSuccess: (res) => {
        if (res.code === 'RECIPE_CREATED') {
          ...
          toast({
            title: 'Yay! 🎉',
            description: SERVER_MESSAGES[res.code] || 'Recipe created successfully',
            variant: 'success'
          })
        }
      }
                ...
                <CardContent>
                  <div className='grid gap-6'>
                    <div className='grid gap-3'>
                      ...
                      <select {...register('perPerson', { required: true })} id='perPerson' title='perPerson' className='shadow  border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline'>
